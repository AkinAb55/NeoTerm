...
if 'uknl_block_dispatch' not in s:
    ...
    helpers = (
        ...
        '{\n'
        '\t/* ONLY the whole-device node /dev/uksd0 — NOT every path ending in\n'
        '\t * "/uksd0" (e.g. the sysfs dir /sys/block/uksd0, which must stay a\n'
        '\t * directory so lsblk/rpi-imager can walk it). */\n'
        '\treturn strcmp(p, "/dev/uksd0") == 0;\n'
        '}\n'
